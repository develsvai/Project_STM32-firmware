...
osThreadId netconnConnectiHandle;
/* USER CODE BEGIN PV */
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
#define SERVER_IP_ADDR "192.168.0.5"
...
/* Configure the peripherals common clocks */
  ...
  /* definition and creation of netconnConnecti */
...
/**
 * @brief Function implementing the netconnConnecti thread.
 * @param argument: Not used
 * @retval None
 */
